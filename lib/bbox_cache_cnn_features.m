function bbox_cache_cnn_features( expidx, video_set, firstidx, nVids, bRecompute)
...
models_dir = fullfile(p.code_dir, '../deepcut/models');
net_def_file = fullfile(models_dir, p.net_def_file);
